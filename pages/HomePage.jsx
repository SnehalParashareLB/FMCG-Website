    ...
    >
      ...
      <section className="py-16 md:py-24 relative overflow-hidden bg-secondary/50">
        <div className="absolute -z-10 top-0 left-0 w-full h-full opacity-50">
           <img src="https://www.transparenttextures.com/patterns/food.png" alt="food pattern" className="w-full h-full object-cover opacity-20 mix-blend-overlay"/>
        </div>
        <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <motion.div
                ...
                >
                  ...
                  <p className="text-foreground/80 mb-4 text-lg">
                    CHITALE SWEET HOME began as a small family business in 1995, with recipes passed down through generations. Our commitment to quality and authentic flavors has made us a trusted name in traditional Indian snacks and sweets.
                  </p>
              ...
              >
                <div className="rounded-xl overflow-hidden shadow-2xl">
                  <img  className="w-full h-full object-cover" alt="Traditional sweet making process with vibrant colors" src="https://images.unsplash.com/photo-1692560253074-3f063a23ba15" />
                </div>
